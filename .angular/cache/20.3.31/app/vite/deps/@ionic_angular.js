...
import {
  ...
  popoverController,
  toastController
} from "./chunk-OYD3EPOF.js";
import "./chunk-IMQVM64D.js";
import {
  openURL
} from "./chunk-3HUDDGKC.js";
import {
  iosTransitionAnimation
} from "./chunk-XFVNWCBX.js";
import {
  mdTransitionAnimation
} from "./chunk-K3UC6F23.js";
import {
  getIonPageElement
} from "./chunk-RRGKHVSK.js";
import {
  createAnimation
} from "./chunk-EYWG3EEX.js";
import "./chunk-SKA6RT2T.js";
import "./chunk-TA32DXPY.js";
import {
  Vt,
  c,
  e,
  ...
  t,
  u
} from "./chunk-PFVA2UFL.js";
import {
  getPlatforms,
  initialize,
  isPlatform
} from "./chunk-JDDVIETK.js";
import "./chunk-TRNENI6K.js";
import {
  createGesture
} from "./chunk-W2DH2WGQ.js";
import "./chunk-D32SLB5J.js";
import "./chunk-QOJD2BNA.js";
...
import {
  ...
  NG_VALUE_ACCESSOR,
  NgControl
} from "./chunk-Y433KW4C.js";
import "./chunk-5TVNOXXV.js";
...
var t2 = class {
  constructor(t4, s6, i5, h3, e3) {
    this.id = s6, this.name = i5, this.disableScroll = e3, this.priority = 1e6 * h3 + s6, this.ctrl = t4;
  }
  canStart() {
...
var s2 = class {
  constructor(t4, s6, i5, h3) {
    this.id = s6, this.disable = i5, this.disableScroll = h3, this.ctrl = t4;
  }
  block() {
    if (this.ctrl) {
...
var h = new class {
  ...
  createGesture(s6) {
    var i5;
    return new t2(this, this.newID(), s6.name, null !== (i5 = s6.priority) && void 0 !== i5 ? i5 : 0, !!s6.disableScroll);
  }
  createBlocker(t4 = {}) {
    return new s2(this, this.newID(), t4.disable, !!t4.disableScroll);
  }
  start(t4, s6, i5) {
    return this.canStart(t4) ? (this.requestedStart.set(s6, i5), true) : (this.requestedStart.delete(s6), false);
  }
  capture(t4, s6, i5) {
    if (!this.start(t4, s6, i5)) return false;
    const h3 = this.requestedStart;
    let e3 = -1e4;
    if (h3.forEach(((t5) => {
      e3 = Math.max(e3, t5);
    })), e3 === i5) {
      this.capturedId = s6, h3.clear();
      const i6 = new CustomEvent("ionGestureCaptured", { detail: { gestureName: t4 } });
      return document.dispatchEvent(i6), true;
    }
    return h3.delete(s6), false;
  }
  release(t4) {
    this.requestedStart.delete(t4), this.capturedId === t4 && (this.capturedId = void 0);
  }
  disableGesture(t4, s6) {
    let i5 = this.disabledGestures.get(t4);
    void 0 === i5 && (i5 = /* @__PURE__ */ new Set(), this.disabledGestures.set(t4, i5)), i5.add(s6);
  }
  enableGesture(t4, s6) {
    const i5 = this.disabledGestures.get(t4);
    void 0 !== i5 && i5.delete(s6);
  }
  disableScroll(t4) {
  ...
  isDisabled(t4) {
    const s6 = this.disabledGestures.get(t4);
    return !!(s6 && s6.size > 0);
  }
  newID() {
...
var a = (o5) => l2(o5);
var s4 = (o5, i5) => ("string" == typeof o5 && (i5 = o5, o5 = void 0), a(o5).includes(i5));
var l2 = (o5 = window) => {
  if (void 0 === o5) return [];
  o5.Ionic = o5.Ionic || {};
  let i5 = o5.Ionic.platforms;
  return null == i5 && (i5 = o5.Ionic.platforms = c2(o5), i5.forEach(((i6) => o5.document.documentElement.classList.add(`plt-${i6}`)))), i5;
};
var c2 = (i5) => {
  const t4 = n.get("platform");
  return Object.keys(j).filter(((o5) => {
    const n2 = null == t4 ? void 0 : t4[o5];
    return "function" == typeof n2 ? n2(i5) : j[o5](i5);
  }));
};
var u2 = (o5) => !!h2(o5, /iPad/i) || !(!h2(o5, /Macintosh/i) || !p(o5));
var m = (o5) => h2(o5, /android|sink/i);
var p = (o5) => w(o5, "(any-pointer:coarse)");
var v = (o5) => f(o5) || b(o5);
var f = (o5) => !!(o5.cordova || o5.phonegap || o5.PhoneGap);
var b = (o5) => {
  const i5 = o5.Capacitor;
  return !!((null == i5 ? void 0 : i5.isNative) || (null == i5 ? void 0 : i5.isNativePlatform) && i5.isNativePlatform());
};
var h2 = (o5, i5) => i5.test(o5.navigator.userAgent);
var w = (o5, i5) => {
  var t4;
  return null === (t4 = o5.matchMedia) || void 0 === t4 ? void 0 : t4.call(o5, i5).matches;
};
var j = { ipad: u2, iphone: (o5) => h2(o5, /iPhone/i), ios: (o5) => h2(o5, /iPhone|iPod/i) || u2(o5), android: m, phablet: (o5) => {
  const i5 = o5.innerWidth, t4 = o5.innerHeight, n2 = Math.min(i5, t4), e3 = Math.max(i5, t4);
  return n2 > 390 && n2 < 520 && e3 > 620 && e3 < 800;
}, tablet: (o5) => {
  const i5 = o5.innerWidth, t4 = o5.innerHeight, n2 = Math.min(i5, t4), e3 = Math.max(i5, t4);
  return u2(o5) || ((o6) => m(o6) && !h2(o6, /mobile/i))(o5) || n2 > 460 && n2 < 820 && e3 > 780 && e3 < 1400;
}, cordova: f, capacitor: b, electron: (o5) => h2(o5, /electron/i), pwa: (o5) => {
  var i5;
  return !(!(null === (i5 = o5.matchMedia) || void 0 === i5 ? void 0 : i5.call(o5, "(display-mode: standalone)").matches) && !o5.navigator.standalone);
}, mobile: p, mobileweb: (o5) => p(o5) && !v(o5), desktop: (o5) => !p(o5), hybrid: v };
var O;
var y = (o5) => o5 && Vt(o5) || O;
...
var i2 = (t4) => {
  let e3, n2;
  const r3 = t4.width + 8, i5 = r(), u5 = r();
  t4.isEndSide ? (e3 = r3 + "px", n2 = "0px") : (e3 = -r3 + "px", n2 = "0px"), i5.addElement(t4.menuInnerEl).fromTo("transform", `translateX(${e3})`, `translateX(${n2})`);
  const c8 = "ios" === y(t4), m3 = c8 ? 0.2 : 0.25;
  return u5.addElement(t4.backdropEl).fromTo("opacity", 0.01, m3), o3(c8).addAnimation([i5, u5]);
};
var u3 = (t4) => {
  let e3, n2;
  const r3 = y(t4), i5 = t4.width;
  t4.isEndSide ? (e3 = -i5 + "px", n2 = i5 + "px") : (e3 = i5 + "px", n2 = -i5 + "px");
  const u5 = r().addElement(t4.menuInnerEl).fromTo("transform", `translateX(${n2})`, "translateX(0px)"), c8 = r().addElement(t4.contentEl).fromTo("transform", "translateX(0px)", `translateX(${e3})`), m3 = r().addElement(t4.backdropEl).fromTo("opacity", 0.01, 0.32);
  return o3("ios" === r3).addAnimation([u5, c8, m3]);
};
var c4 = (t4) => {
  const e3 = y(t4), n2 = t4.width * (t4.isEndSide ? -1 : 1) + "px", r3 = r().addElement(t4.contentEl).fromTo("transform", "translateX(0px)", `translateX(${n2})`);
  return o3("ios" === e3).addAnimation(r3);
};
var m2 = (() => {
  const s6 = /* @__PURE__ */ new Map(), a4 = [], o5 = (t4, e3 = false) => __async(null, null, function* () {
    if (yield d3(), "start" === t4 || "end" === t4) {
      const r3 = a4.filter(((e4) => e4.side === t4 && !e4.disabled));
      if (r3.length >= 1) return r3.length > 1 && e3 && u(`menuController queried for a menu on the "${t4}" side, but ${r3.length} menus were found. The first menu reference will be used. If this is not the behavior you want then pass the ID of the menu instead of its side.`, r3.map(((t5) => t5.el))), r3[0].el;
      const s7 = a4.filter(((e4) => e4.side === t4));
      if (s7.length >= 1) return s7.length > 1 && e3 && u(`menuController queried for a menu on the "${t4}" side, but ${s7.length} menus were found. The first menu reference will be used. If this is not the behavior you want then pass the ID of the menu instead of its side.`, s7.map(((t5) => t5.el))), s7[0].el;
    } else if (null != t4) return w2(((e4) => e4.menuId === t4));
    return w2(((t5) => !t5.disabled)) || (a4.length > 0 ? a4[0].el : void 0);
  }), m3 = () => __async(null, null, function* () {
    return yield d3(), f3();
  }), p3 = (t4, e3) => {
    s6.set(t4, e3);
  }, f3 = () => w2(((t4) => t4._isOpen)), l6 = () => a4.some(((t4) => t4.isAnimating)), w2 = (t4) => {
    const e3 = a4.find(t4);
    if (void 0 !== e3) return e3.el;
  }, d3 = () => Promise.all(Array.from(document.querySelectorAll("ion-menu")).map(((t4) => new Promise(((e3) => e(t4, e3))))));
  return p3("reveal", c4), p3("push", u3), p3("overlay", i2), null == o || o.addEventListener("ionBackButton", ((t4) => {
    const n2 = f3();
    n2 && t4.detail.register(c3, (() => n2.close()));
  })), { registerAnimation: p3, get: o5, getMenus: () => __async(null, null, function* () {
    return yield d3(), a4.map(((t4) => t4.el));
  }), getOpen: m3, isEnabled: (t4) => __async(null, null, function* () {
    const e3 = yield o5(t4);
    return !!e3 && !e3.disabled;
  }), swipeGesture: (t4, e3) => __async(null, null, function* () {
    const n2 = yield o5(e3);
    return n2 && (n2.swipeGesture = t4), n2;
  }), isAnimating: () => __async(null, null, function* () {
    return yield d3(), l6();
  }), isOpen: (t4) => __async(null, null, function* () {
    if (null != t4) {
      const e3 = yield o5(t4);
      return void 0 !== e3 && e3.isOpen();
    }
    return void 0 !== (yield m3());
  }), enable: (t4, e3) => __async(null, null, function* () {
    const n2 = yield o5(e3);
    return n2 && (n2.disabled = !t4), n2;
  }), toggle: (t4) => __async(null, null, function* () {
    const e3 = yield o5(t4, true);
    return !!e3 && e3.toggle();
  }), close: (t4) => __async(null, null, function* () {
    const e3 = yield void 0 !== t4 ? o5(t4, true) : m3();
    return void 0 !== e3 && e3.close();
  }), open: (t4) => __async(null, null, function* () {
    const e3 = yield o5(t4, true);
    return !!e3 && e3.open();
  }), _getOpenSync: f3, _createAnimation: (t4, e3) => {
    const n2 = s6.get(t4);
    if (!n2) throw new Error("animation not registered");
    return n2(e3);
  }, _register: (t4) => {
    a4.indexOf(t4) < 0 && a4.push(t4);
  }, _unregister: (t4) => {
    const e3 = a4.indexOf(t4);
    e3 > -1 && a4.splice(e3, 1);
  }, _setOpen: (t4, e3, n2, r3) => __async(null, null, function* () {
    if (l6()) return false;
    if (e3) {
      const e4 = yield m3();
      e4 && t4.el !== e4 && (yield e4.setOpen(false, false));
    }
    return t4._setOpen(e3, n2, r3);
  }) };
})();

// node_modules/@ionic/core/components/p-W9CZ2mWX.js
var T = (n2) => ({ create: (o5) => N(n2, o5), dismiss: (o5, e3, t4) => E(document, o5, e3, n2, t4), getTop: () => __async(null, null, function* () {
  return L(document, n2);
}) });
var k = T("ion-alert");
...
var B = T("ion-popover");
var D = T("ion-toast");
var N = (n2, o5) => "undefined" != typeof window && void 0 !== window.customElements ? window.customElements.whenDefined(n2).then((() => {
  const t4 = document.createElement(n2);
  return t4.classList.add("overlay-hidden"), Object.assign(t4, Object.assign(Object.assign({}, o5), { hasController: true })), z(document).appendChild(t4), new Promise(((n3) => e(t4, n3)));
})) : Promise.resolve();
var E = (n2, o5, e3, t4, i5) => {
  const a4 = L(n2, t4, i5);
  return a4 ? a4.dismiss(o5, e3) : Promise.reject("overlay does not exist");
};
var F = (n2, o5) => ((n3, o6) => (void 0 === o6 && (o6 = "ion-alert,ion-action-sheet,ion-loading,ion-modal,ion-picker-legacy,ion-popover,ion-toast"), Array.from(n3.querySelectorAll(o6)).filter(((n4) => n4.overlayIndex > 0))))(n2, o5).filter(((n3) => !n3.classList.contains("overlay-hidden")));
var L = (n2, o5, e3) => {
  const t4 = F(n2, o5);
  return (void 0 === e3 ? t4 : t4.filter(((n3) => n3.id === e3))).slice(-1)[0];
};
var z = (n2) => n2.querySelector("ion-app") || n2.body;
...
var Platform = class _Platform {
   ...
   */
  is(platformName) {
    return s4(this.win, platformName);
  }
  /**
...
var IonModal = (
  ...
  class IonModal2 {
    ...
    isCmpOpen = false;
    el;
    constructor(c8, r3, z3) {
      this.z = z3;
      this.el = r3.nativeElement;
...
var IonBackButton = class IonBackButton2 {
  ...
  z;
  el;
  constructor(routerOutlet, navCtrl, config, r3, z3, c8) {
...
var IonBackButton3 = class _IonBackButton extends IonBackButton {
  constructor(routerOutlet, navCtrl, config, r3, z3, c8) {
    super(routerOutlet, navCtrl, config, r3, z3, c8);
  }
  /** @nocollapse */
  static ɵfac = function IonBackButton_Factory(__ngFactoryType__) {
...
var IonNav3 = class _IonNav extends IonNav {
  constructor(ref, environmentInjector, injector, angularDelegate, z3, c8) {
    super(ref, environmentInjector, injector, angularDelegate, z3, c8);
  }
  /** @nocollapse */
  static ɵfac = function IonNav_Factory(__ngFactoryType__) {
  ...
  return () => {
    ...
    if (win && typeof window !== "undefined") {
      ...
      return defineCustomElements(win, {
        ...
        syncQueue: true,
        raf,
        jmp: (h3) => zone.runOutsideAngular(h3),
